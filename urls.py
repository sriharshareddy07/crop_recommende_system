...
from crop_recommender_system import settings
...
urlpatterns = [
    ...
    url(r'^Recommend_Crop/$', remoteuser.Recommend_Crop, name="Recommend_Crop"),

    url(r'^ViewYourProfile/$', remoteuser.ViewYourProfile, name="ViewYourProfile"),
    url(r'^View_All_Crop_Recommendations/$',serviceprovider.View_All_Crop_Recommendations, name="View_All_Crop_Recommendations"),
